...
namespace GameRandomizer.Controllers
{
    ...
    {
        private readonly GameRandomizerContext _context;

        public GamesController(GameRandomizerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GameRandomizerContext.Game'  is null.");
            }
            var game = await _context.Game.FindAsync(id);
            if (game != null)
            {
